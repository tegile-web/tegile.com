<div class="row-wide no-padding-bottom bg-smoke">
	<div class="row">
		<div class="small-12 columns">
			<p class="uppercase font-weight-bold color-lead font-size-h4 no-margin-bottom">White Paper</p>
		</div>
	</div>
</div>
<div class="row-wide no-padding-top padding-bottom-300rem bg-smoke">
	<div class="row">	
		<div class="small-12 medium-7 large-7 columns">
			...
			<p class="use-cases color-lead font-size-h5"><span class="uppercase-bold">Use Cases:</span> <?php echo get_sub_field('use_cases'); ?></p>
		...
		<div class="small-12 medium-5 large-5 columns text-center">
			...
			<a href="<?php the_sub_field('resource_link') ?>" class="asset-pdf-image" target="_blank">
				<?php $image = get_sub_field('asset_image'); ?>
				<img src="<?php echo $image['url'] ?>" alt="<?php echo the_title(); ?>">
			</a>
			<p><a href="<?php echo get_sub_field('resource_link') ?>" target="_blank" class="button">Get the White Paper</a></p>
		</div>
	</div>
</div>