<div class="row-wide no-padding-bottom bg-smoke">
	<div class="row">
		<div class="small-12 columns">
			<p class="uppercase font-weight-bold color-lead font-size-h4 no-margin-bottom">Solution Brief</p>
		</div>
	</div>
</div>
<div class="row-wide no-padding-top padding-bottom-300rem bg-smoke">
	<div class="row">	
		...
		<div class="small-12 medium-5 large-5 columns text-center">
			...
			<p><a href="<?php echo get_sub_field('resource_link') ?>" target="_blank" class="button">Get the Brief</a></p>
		</div>
	</div>
</div>