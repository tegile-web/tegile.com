<?php
/**
 * Template Name: Press Release Grid
  ...
  <div id="main" role="main">
    ...
    <?php get_template_part('core/page-blocks'); ?>
		<?php if ( have_posts() ) : ?>
				...
				<div class="row-wide">
					<div class="row">
						<div class="small-12 columns">
							<h1 class="text-center font-size-h1-hero-bold">Press Releases</h1>
							<?php the_content(); ?>
						</div>
					</div>
				</div>
				...
				<div class="row" data-equalizer data-options="equalize_on_stack: true">
						...
						<?php $wp_query = new WP_Query( 'post_type=' . $post_type . '&posts_per_page=' . $show_posts . '&paged=' . $paged ); ?>
							...
							<div class="small-12 medium-6 large-4 columns text-center">
								<a class="news-link-grid-layout" href="<?php echo the_permalink(); ?>" rel="bookmark" title="<?php echo the_title_attribute(); ?>" target="_blank">
						      	...
						      	<p class="no-margin-bottom"><a class="go" href="<?php echo the_permalink(); ?>" target="_blank">Go to press release</a></p>
										<div class="clear"></div>
									</div>
								</a>
							</div><!-- .small-12 -->
						...
						<div class="padding-top-200rem padding-bottom-400rem">
			...
			</div> <!-- .row-wide .bg-smoke .no-padding-top -->
		<?php endif; ?>
